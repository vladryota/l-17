                        ...
                        <div class="panel-content">
                            <div class="panel-content">
                                <div class="bg-warning-100 border border-warning rounded">
                                    ...
                                    <?php /* Первое практическое задание, работа с циклом и вывод при поиске. */
                                        $name = [ // создаем массив 
                                            [
                                                'item' => 'Reports',
                                                'tags' => 'reports file',
                                    ...
                                    <ul id="js-list-msg" class="list-group px-2 pb-2 js-list-filter">
                                        <?php foreach ($name as $item):  // перебираем массив и выводим с помощью цикла?> 
                                            <li class="list-group-item">
                                            <span data-filter-tags="<?php echo $item['tags'] ;?>"> <?php echo $item['item']; ?> </span>
                                        </li>
                                        <?php endforeach; // заканчиваем цикл ?>
                                    </ul>
